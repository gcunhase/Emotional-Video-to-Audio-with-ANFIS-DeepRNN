...
save_root = 'saved_mats/deap/features_from_sound/train/';
save_to_filename = strcat([save_root, 'sound_features_dataset2_deap_size', num2str(size_sound_feats), '_v7_raw']);
...
feats_per_song = 50*ones(1,s_files); %[100, 200, 225, 200, 180, 200, 200, 200];%, 210];
