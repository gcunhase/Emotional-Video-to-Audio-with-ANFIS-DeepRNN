...
% References:
%   http://dsp.stackexchange.com/questions/11467/apply-a-gabor-filter-to-an-input-image
%   http://cs.brown.edu/courses/csci1290/2011/results/final/gen/
...
for n = 1:Nfilters
    ...
    ig = abs(ifft2(conv2(img, repmat(G(:,:,n), [1 1 N]))));    
    v = downN(ig, w);
