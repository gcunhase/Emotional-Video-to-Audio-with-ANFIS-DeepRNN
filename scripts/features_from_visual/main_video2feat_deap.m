...
load(strcat([save_root, 'HSLO_data_dataset_deap_', num2str(n), '.mat']));
%load EEG_GIST
...
train_O_data = reshape(temp,[12 2016*number_items])'; %112*number_items])';
train_H_data = reshape(train_H,[12600*number_items 1]); %[700*number_items 1]);
train_S_data = reshape(train_S,[12600*number_items 1]);
train_L_data = reshape(train_L,[12600*number_items 1]);
...
save(strcat([save_root, 'feature_dataset_deap_', num2str(n), '_v7']), 'Feature_train', 'movie_id', '-v7');
save(strcat([save_root, 'number_of_sort_dataset_deap_', num2str(n), '_v7']), 'num_sort', 'number_items', '-v7');
